...
public class Game {
	...
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	displayMapReset();
	splitMsg( 9, "Hello there! It's a pleasure to meet you!", 30);
	System.out.println( userMap );
	waitMS( 2500 );

	displayMapReset();
	splitMsg( 9, "Welcome to the world of Pokemon!", 30);
	System.out.println( userMap );
	waitMS( 2500 );

	displayMapReset();
	splitMsg( 9,"My name is Oak, but everyone just calls me the Pokemon Professor." , 30);
	System.out.println( userMap );
	waitMS( 2500 );

        displayMapReset();
	splitMsg( 9,"This world is widely inhabited by creatures known as Pokemon." , 30);
	System.out.println( userMap );
	waitMS( 2500 );

	displayMapReset();
	splitMsg( 9,"We humans live alongside Pokemon as friends." , 30);
	System.out.println( userMap );
	waitMS( 2500 );
	
	displayMapReset();
	splitMsg( 9, "At times we play together, and at other times we work together.", 30);
	System.out.println( userMap );
	waitMS( 2500 );

	displayMapReset();
	splitMsg( 9, "Some people use their Pokemon to battle and develop close bonds with them.", 30);
	System.out.println( userMap );
	waitMS( 2500 );

	displayMapReset();
	splitMsg( 9, "And what do I do? I conduct research so that we may learn more about Pokemon.", 30);
	System.out.println( userMap );
	waitMS( 2500 );

	displayMapReset();
	splitMsg( 9, "Now, why don't you tell me a little bit about yourself?", 30);
	System.out.println( userMap );
	waitMS( 2500 );
	...
	while( name.length() > 8 ) {
	    displayMapReset();
	    splitMsg( 9, "All right. Tell me, what is your name? (1-8 characters)", 30);
	    System.out.println( userMap );
	...
	while( !gen.toLowerCase().equals("boy")&&!gen.toLowerCase().equals("girl") ) {
	    displayMapReset();
	    splitMsg( 9, "Tell me, are you a boy? Or are you a girl?", 30);
	    System.out.println( userMap );
	...
	displayMapReset();
	splitMsg( 9, "In this world of Pokemon, you'll need a partner Pokemon to be with you.", 30);
	System.out.println( userMap );
	waitMS( 2500 );

	displayMapReset();
	splitMsg( 9, "Tell me, which Pokemon would you like to be your partner?", 30);
	System.out.println( userMap );
	waitMS( 2500 );
	...
	while( !pkm.equals("1") && !pkm.equals("2") && !pkm.equals("3") ) {
	    displayMapReset();
	    splitMsg( 8, "1. Bulbasaur                 2. Charmander                 3. Squirtle", 30);
	    System.out.println( userMap );
	...
	displayMapReset();
	splitMsg( 9, "CONGRATULATION, you have defeated the champion and saved the pokemon world", 30);
	System.out.println( userMap );
	waitMS( 3000 );
	...
	displayMapReset();
	splitMsg( 9, "Professor Oak: Thank you for bringing back the lost peace of this world", 30);
	System.out.println( userMap );
	waitMS( 2500 );
	...
	displayMapReset();
	splitMsg( 9, "Professor Oak: Please remember us and the pokemons", 30);
	System.out.println( userMap );
	waitMS( 2500 );
    }
	...
	if( mapScreen == 1 ) {      //Pokecenter
	    ...
	    displayMapReset();
	    splitMsg( 9, "You do not have a key item to perform such task...", 30);       
	    System.out.println( userMap );
	    waitMS( 2000 );

	    displayMapReset();
	    splitMsg( 9, "Defeat gym leaders to obtain key items!", 30);
	    System.out.println( userMap );
	    waitMS( 2000 );
