...
public class Player {
    ...
    private static int badges, money, mapNum, fromMap, xCor, yCor, pokemonLeft, RxCor, RyCor, Rmap;
    ...
    public static int getRmap() { return Rmap; }
